...
public class c1_Introduction extends IntroductionBase {
    ...
    public void fortune_top_five() {
        ...
        List<String> results = fortuneTop5()
            .collectList()
            .block();
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
          .doOnEach(signal -> signalLogic(signal, companyList, serviceCallCompleted))
          .subscribe();
    ...
    private void signalLogic(Signal<String> signal, CopyOnWriteArrayList<String> list, AtomicReference<Boolean> serviceCallCompleted) {
      if (signal.hasValue()) {
        list.add(signal.get());
